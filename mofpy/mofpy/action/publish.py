...
class Publish(Action):
    ...
    def __init__(self, definition, node):
        ...
        self.__pub, self.__msg_class = self.create_publisher(self.__topic_name, self.__topic_type, self.__qos_profile)
    ...
    def execute(self, named_joy=None):
        ...
        try:
            ...
            rclpy.logging.get_logger("mofpy.Publish").error('Failed to populate field: {0}'.format(e))
            return
